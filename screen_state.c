...
#define SC_CASINO 0x04U
#define SC_APPLIANCE_STORE_CASINO_SHARED 0x08U
...
#define SC_APPLIANCE_STORE_CASINO_SHARED_TRANSITION_X 0x1EU
#define SC_APPLIANCE_STORE_CASINO_SHARED_TRANSITION_Y 0x09U
